...
#MODEL = DeepLabModel('/mnt/c/Users/jithi/Desktop/tf/xception_coco_voctrainval.gz')
MODEL = DeepLabModel('xception_coco_voctrainval.gz')
print('model loaded successfully!')


################################

def run_visualization_blur(original_im):
  ...
  seg_map=cv2.blur(seg_map,(5,5))

  image = np.array(image)
  image_blur=cv2.blur(image,(5,5))
  #image_blur=Image.fromarray(image_blur)
  seg_image = label_to_color_image(seg_map).astype(np.uint8)
  print("printing shape",image_blur.shape,seg_image.shape)
...
cv2.imwrite('musk_x_blur.png',run_visualization_blur(img))
